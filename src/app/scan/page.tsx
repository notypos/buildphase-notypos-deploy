  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-10">
      ...
      <p className="mt-1 mb-8 text-slate-600">
        Scan a barcode to pull NIH&apos;s own record for that product, or photograph the
        Supplement Facts panel directly. Sign in to add what you want to My Stack.
      </p>
      ...
      <p className="mt-8 rounded-xl bg-teal-50 p-5 text-sm text-teal-900">
        ...
        is sent once to extract the printed doses and is discarded; a barcode is looked up against
        NIH&apos;s public database, not saved. The upper-limit and cumulative-dose check that runs
        on My Stack never changes based on how an item got there — scanned or typed in by hand.
      </p>
    </main>
  );
}
